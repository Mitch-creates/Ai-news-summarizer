...
from sqlalchemy import ARRAY, JSON, Column, DateTime, ForeignKey, Integer, String, Text
...
class BlogPost(Base):
    ...
    newsletter_sources = Column(JSON, nullable=False) 
    ...
    tags = Column(JSON, nullable=False)  # Storing list as an array (use PostgreSQL)
